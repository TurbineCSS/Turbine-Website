...
<p class="warning">
	This document describes <em>Turbine 1.1</em>, which is currently in beta state. This document may be slightly out of date. You can find the docs for the 1.0 branch in the <a href="docs.php">current docs</a>.
</p>
<p>
...
<h3 id="faq-static">What about non-server environments? Can I use Turbine from my editor/php-cli and use the generated css code as static content?</h3><div>
<p>
	Turbine would problably work to some extend but many of it's operations (mostly plugins) depend on user-agent sniffing and on devlivering slightly
	different css code to different user agents.
</p>
</div>
